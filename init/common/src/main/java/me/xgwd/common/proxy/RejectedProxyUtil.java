...
package me.xgwd.common.proxy;

import lombok.AccessLevel;
import lombok.NoArgsConstructor;
import me.xgwd.common.util.ThreadUtil;
        ...
        for (int i = 0; i < 5; i++) {
            try {
                threadPoolExecutor.execute(() -> {
                    System.out.println(threadPoolExecutor.getTaskCount() + " " + threadPoolExecutor.getActiveCount() + " " + Thread.currentThread());
