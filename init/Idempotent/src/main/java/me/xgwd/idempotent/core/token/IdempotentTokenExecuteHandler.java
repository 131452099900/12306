...
package me.xgwd.idempotent.core.token;
...
import me.xgwd.idempotent.config.IdempotentProperties;
...
public final class IdempotentTokenExecuteHandler extends AbsHandler implements  IdempotentTokenService{
    ...
    /**
     * * 如果header有token，同时删除成功 是否需要使用lua脚本
     */
    @Override
