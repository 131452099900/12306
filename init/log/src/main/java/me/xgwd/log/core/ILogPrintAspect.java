...
package me.xgwd.log.core;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.date.SystemClock;
import cn.hutool.json.JSONUtil;

import me.xgwd.log.annotation.ILog;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(me.xgwd.log.annotation.ILog) || @annotation(me.xgwd.log.annotation.ILog)")
    public Object printMLog(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            if (logAnnotation != null) {
                ...
                log.info("[{}] {}, executeTime: {}ms, info: {}", methodType, requestURI, SystemClock.now() - startTime,
