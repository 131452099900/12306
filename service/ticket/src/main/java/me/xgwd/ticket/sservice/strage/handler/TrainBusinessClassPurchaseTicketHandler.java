package me.xgwd.ticket.sservice.strage.handler;

/**
 * Created with IntelliJ IDEA.
 *
 * @Author:
 * @Date: 2024/09/24/18:02
 * @Description:
 */
...
import me.xgwd.ticket.sservice.strage.AbstractTrainPurchaseTicketTemplate;
import me.xgwd.ticket.sservice.strage.bitmap.BitMapCheckSeat;
import me.xgwd.ticket.sservice.strage.bitmap.BitMapCheckSeatStatusFactory;
import me.xgwd.ticket.token.dto.SelectSeatDTO;
import me.xgwd.ticket.token.dto.TrainPurchaseTicketRespDTO;
import me.xgwd.ticket.util.CarriageVacantSeatCalculateUtil;
import me.xgwd.ticket.util.SeatNumberUtil;
import me.xgwd.ticket.util.SeatSelection;
...
public class TrainBusinessClassPurchaseTicketHandler extends AbstractTrainPurchaseTicketTemplate {
    ...
    private Pair<List<TrainPurchaseTicketRespDTO>, Boolean> findMatchSeats(SelectSeatDTO requestParam, List<String> trainCarriageList, List<Integer> trainStationCarriageRemainingTicket) {
        ...
        BitMapCheckSeat instance = BitMapCheckSeatStatusFactory.getInstance(BitMapCheckSeatStatusFactory.TRAIN_BUSINESS);
